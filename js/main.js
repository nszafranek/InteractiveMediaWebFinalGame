...
function draw() {
  ...
  if ((!gameOver) && (!startGame)) {
    ...
    if (screen.width <= 800) {
      ...
      textSize(14);
      strokeWeight(1);
      text("Use the Arrow Keys or swipe in one direction to move the hero!", (width / 2), ((height / 2) + 15));
      text("Press Esc to end", (width / 2), ((height / 2) + 25));
      text("Avoid the Sharks and collect Gems and Coins!", (width / 2), ((height / 2) + 35));
      textSize(30);
      strokeWeight(8);
    ...
    if (screen.width > 800) {
      ...
      textSize(15);
      strokeWeight(5);
      text("Use the Arrow Keys or swipe in one direction to move the hero", (width / 2), ((height / 2) + 7));
      text("Press Esc to end", (width / 2), ((height / 2) + 34));
      text("Avoid the Sharks and collect Gems and Coins!", (width / 2), ((height / 2) + 54));
      textSize(30);
      strokeWeight(3);
