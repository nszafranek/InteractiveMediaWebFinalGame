...
function draw() {
  ...
  if ((!gameOver) && (!startGame)) {
    ...
    textAlign(CENTER);
    textFont(gameFont);
    if (screen.width <= 768 && (screen.orientation === "portrait-primary" || mozScreen.orientation === "portrait-primary")) {
      strokeWeight(1);
      textSize(50);
      strokeWeight(10);
    ...
    if (screen.width <= 768 && (screen.orientation === "landscape-primary" || mozScreen.orientation === "landscape-primary")) {
      strokeWeight(1);
      textSize(60);
      strokeWeight(10);
